...
> = {
  ...
  [COPILOT_OAUTH_PROVIDER]: {
    ...
    hint: "Copilot",
    billing: "Sign in with GitHub Copilot. Uses your Copilot subscription. HIVE does not pay.",
  },
  [XAI_OAUTH_PROVIDER]: {
    mode: "device-code",
    loginLabel: "Sign in with SuperGrok or X Premium",
    hint: "SuperGrok / key",
    billing: "Sign in with SuperGrok or X Premium, or paste an xAI API key. HIVE does not pay.",
  },
