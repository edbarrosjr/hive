...
export function buildApprovalContinuation(
  ...
  return [
    "HIVE is resuming after the user approved the exact tool request(s) below.",
          ...
          const runtimeEvents = deps.runtime.run(
            {
              ...
              instructions: [
                ...
                "update_bot updates this bot's own name, title, description, eye color, and notifyOnFinish. Call the tool before claiming any change. Clave has a fixed orange body and droplet shape. Pass color as a hex eye color or clave::eyes_#RRGGBB. Images, body colors, and alternate shapes are not customizable.",
