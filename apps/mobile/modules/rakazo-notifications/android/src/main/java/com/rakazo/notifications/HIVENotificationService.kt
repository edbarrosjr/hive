...
class HIVENotificationService : Service() {
  ...
  private fun liveStatusIcon(): Icon {
    ...
    canvas.scale(96f / 256f, 96f / 256f)
    val body = Path().apply {
      moveTo(119f, 28f)
      quadTo(129f, 20f, 139f, 28f)
      cubicTo(185f, 63f, 222f, 111f, 222f, 151f)
      cubicTo(222f, 204f, 183f, 234f, 129f, 234f)
      cubicTo(75f, 234f, 38f, 204f, 38f, 151f)
      cubicTo(38f, 110f, 76f, 63f, 119f, 28f)
      close()
    }
    ...
    canvas.drawRoundRect(85f, 113f, 117f, 182f, 16f, 16f, eyes)
    canvas.drawRoundRect(141f, 113f, 173f, 182f, 16f, 16f, eyes)
