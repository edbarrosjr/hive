export const ZH_MESSAGES: Record<string, string> = {
  ...
  "Message event": "消息事件",
  "Teams not enabled": "未启用 Teams",
  "Slack not enabled": "未启用 Slack",
  "Teams message": "Teams 消息",
  Group: "群组",
  "Group name": "群组名称",
  ...
  "Enter your HIVE server address.": "输入你的 HIVE 服务器地址。",
  "Show less": "收起",
  Members: "成员",
  Max: "最高",
  Minimal: "最低",
  ...
  "Point this app at your self-hosted HIVE origin, the same HTTPS URL you open in a browser.":
    "将此应用指向你自托管的 HIVE 源站，地址与你在浏览器中打开的 HTTPS URL 相同。",
  Private: "私有",
  Providers: "提供商",
  ...
  "Show {label}": "显示 {label}",
  "Sign in": "登录",
  "Sign in to HIVE": "登录 HIVE",
  "Sign out": "退出登录",
  "Sign up": "注册",
  "Sign up for HIVE": "注册 HIVE",
  "Sign-in": "登录",
  "Sign-up": "注册",
  ...
  "That URL did not look like a HIVE server": "该地址看起来不是 HIVE 服务器",
  ...
  "Paste the OpenAI-compatible address from your server. HIVE adds /v1 if needed.":
    "粘贴你服务器的 OpenAI 兼容地址。如有需要，HIVE 会自动补上 /v1。",
  Paused: "已暂停",
  Prompt: "提示词",
  ...
  "This subscription sign-in is not available in HIVE yet. Use a deployment credential or choose another provider.":
    "HIVE 暂不支持此订阅登录。请使用部署凭据或选择其他提供商。",
  "Tool sources": "工具源",
  Tools: "工具",
  Uninstall: "卸载",
