export const RU_MESSAGES: Record<string, string> = {
  ...
  "Enter your HIVE server address.": "Введите адрес вашего сервера HIVE.",
  "Show less": "Свернуть",
  Members: "Участники",
  ...
  "Point this app at your self-hosted HIVE origin, the same HTTPS URL you open in a browser.":
    "Направьте это приложение на свой собственный источник HIVE, тот же URL-адрес HTTPS, который вы открываете в браузере.",
  Private: "Личный",
  ...
  "Sign in": "Войти",
  "Sign in to HIVE": "Войти в HIVE",
  "Sign out": "Выйти",
  "Sign up": "Зарегистрироваться",
  "Sign up for HIVE": "Зарегистрироваться в HIVE",
  "Sign-in": "Вход",
  "Sign-up": "Регистрация",
  ...
  "That URL did not look like a HIVE server": "Этот адрес не похож на сервер HIVE",
  ...
  "Paste the OpenAI-compatible address from your server. HIVE adds /v1 if needed.":
    "Вставьте OpenAI-совместимый адрес со своего сервера. При необходимости HIVE добавляет /v1.",
  ...
  "This subscription sign-in is not available in HIVE yet. Use a deployment credential or choose another provider.":
    "Вход по этой подписке пока недоступен в HIVE. Используйте учётные данные развёртывания или выберите другого провайдера.",
