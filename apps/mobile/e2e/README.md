...
expects a running HIVE stack and deliberately stays out of ordinary pull-request CI.

## Prerequisites

1. Install the Maestro CLI and start an Android emulator or iOS simulator.
2. Start HIVE's database, API, worker, and sandbox supervisor. The computer portion requires a
